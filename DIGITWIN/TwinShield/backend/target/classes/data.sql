...
INSERT INTO resources (id, name, resource_type, sensitivity_score, is_decoy, description) VALUES
...
INSERT INTO employees (id, name, email, department, role_id, status, created_at) VALUES
...
INSERT INTO behavioral_digital_twin_profiles (employee_id, normal_start_hour, normal_end_hour, avg_daily_accesses, avg_session_duration_minutes, normal_location, known_devices, known_ip_ranges, typical_resources, last_baseline_update) VALUES
...
INSERT INTO sessions (session_id, employee_id, ip_address, location_city, device_fingerprint, user_agent, login_time, last_activity_time, status) VALUES
...
INSERT INTO security_events (id, session_id, employee_id, event_type, severity, description, created_at) VALUES
...
INSERT INTO incidents (id, incident_code, employee_id, session_id, predicted_threat_type, threat_confidence, risk_score_at_trigger, status, created_at) VALUES
